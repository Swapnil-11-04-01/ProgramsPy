...
def main(event):
    ...
    def open1(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\1.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\2.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\3.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\4.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\5.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\6.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\7.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\8.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\9.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 1\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 1\\10.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))

    def open2(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 2\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
    ...
    def open3(event):
        ...
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 3\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
    ...
    def open4(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 4\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
    ...
    def open5(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 5\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
    ...
    def open6(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 6\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
    ...
    def open7(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 1.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\1.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\2.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\3.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\4.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\5.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\6.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\7.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\8.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\9.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 7\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 7\\10.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))

    def open8(event):
        if event.widget.cget("text") == "Problem - 1":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 1.txt", "r")
            question.config(text=file.read(), foreground="white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\1.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 2":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 2.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\2.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 3":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 3.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\3.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 4":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 4.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\4.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 5":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 5.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\5.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 6":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 6.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\6.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 7":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 7.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\7.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 8":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 8.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\8.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 9":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 9.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\9.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 10":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 10.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\10.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
        elif event.widget.cget("text") == "Problem - 11":
            codeArea.delete(1.0, END)
            file = open(r"Assignments\Assignment - 8\Problem - 11.txt", "r")
            question.config(text = file.read(), foreground = "white")
            file.close()
            codeFile = open(r"Assignments\Assignment - 8\\11.py", "rb")
            viewBtn.config(command = partial(viewCode, codeFile))
